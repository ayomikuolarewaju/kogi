...
const page = () => {
  return (
    <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex w-screen overflow-hidden'>
      <div className=' flex flex-col justify-center items-center  h-screen bg-gradient-to-tl from-[#054CA8] to-[#010B48] bg-contain w-full md:w-1/2 md:absolute md:top-0 md:left-[870px]'>
        <Formsy
          div1={!true}
          name1='companytaxid'
          label1="enter your company's tax id"
          type1='text'
          div2={!true}
          name2='taxId'
          label2='tax id'
          ...
          okaybtn={!true}
        />
        <div className='flex flex-col w-[600px] justify-center gap-y-3 items-center text-center md:translate-y-[-30px] translate-y-[-10px]'>
          <Link
